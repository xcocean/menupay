...
public class OrderService {
    ...
    public List<Map<String, String>> getOrder(Context context, String username, String token) throws IOException {
        ...
        if (res != null) {
            ...
            for (int i = 0; i < orders.size(); i++) {
                db.execSQL("insert into user_order(id,seat,create_time,price,order_number,name,handle_status,menu_id,username,status,describe)" +
